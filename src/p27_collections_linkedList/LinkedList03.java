...
public class LinkedList03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(ll1.remove(0)); // remove(index) indexdeki elemani siler ve  sildigi elemani bize dondurur
		// Eger listemiz integer'lardan olusuyorsa parantez icine yazdigimiz sayinin index mi yoksa sayi mi oldugunu karistirmamak icin
