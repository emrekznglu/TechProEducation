...
public class Queue01 {
	...
	public static void main(String[] args) {
		...
		// fakat ayni elemanlarla LinkedList constructor'i kullanarak olusturdugumuz
		...
		k2.remove(); // bu satirda son eleman olan Z de silindi, artik queue bos
